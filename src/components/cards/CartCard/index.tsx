...
export default function CartCard({ products, emptyCartCardMessage }: CartCardProps) {
  ...
  return (
    <div className="flex flex-col bg-background text-foreground/70 sm:pr-1">
      <span className="mb-4 text-foreground">Seu carrinho</span>
        <div className="flex flex-col bg-background text-foreground/70 sm:pr-1 max-h-[50vh] overflow-y-auto">
